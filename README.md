...
<a href="https://render.com/deploy?repo=https://github.com/diegogd/trigger.dev-basic-example">
...
```sh
git clone https://github.com/diegogd/trigger.dev-basic-example.git
cd trigger.dev-basic-example
npm install
```
